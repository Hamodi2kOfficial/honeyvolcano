      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 md:grid-cols-2 md:gap-16">
        ...
        >
          ...
          <motion.p
            variants={rise}
            custom={3}
            className="mt-4 max-w-md text-base font-light leading-relaxed text-foreground-muted"
          >
            {t.story.body2}
          </motion.p>
          ...
          >
            {[t.story.stat1, t.story.stat2, t.story.stat3].map((s) => (
              <span
                key={s}
        ...
        >
          ...
          >
            <Image
              src="/lifestyle.jpg"
              alt="Raw forest honey poured against snow-capped mountains and wild lupine fields"
              fill
